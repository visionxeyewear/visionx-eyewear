    ...
    <div className="min-h-screen bg-white text-gray-900 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Filters Sidebar (Placeholder layout matching your screen) */}
          <div className="md:col-span-1 border-r border-gray-200 pr-6">
            <h3 className="font-bold text-lg mb-4">FILTERS</h3>
            <div className="space-y-6 text-sm">
              <div>
                <label className="font-medium block mb-2">MAX PRICE: ₹3000</label>
          ...
          <div className="md:col-span-3">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((product) => (
                <div key={product.id} className="bg-white rounded-xl p-4 border border-gray-200 group shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <button className="w-full border border-gray-900 text-gray-900 py-2 px-4 rounded-md text-xs font-semibold hover:bg-gray-900 hover:text-white transition-colors">
                      View Product
                    </button>
                  </div>
                </div>
